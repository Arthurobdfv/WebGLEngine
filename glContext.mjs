...
export function setRectangle(gl, x, y, width, height) {
  ...
  export function getRectangle(x, y, width, height, depth = 10){
    ...
    return new Float32Array([
        ...
        // Left Side?
        x1,y1,depth,    -1, 0, 0,   1, 0, 0,
        x1,y1,0,        -1, 0, 0,   0, 1, 0,
        x1,y2,depth,    -1, 0, 0,   0, 0, 1,
        x1,y2,depth,    -1, 0, 0,   1, 0, 0,
        x1,y1,0,        -1, 0, 0,   0, 1, 0,
        x1,y2,0,        -1, 0, 0,   0, 0, 1,
        ...
        // top side
        x1, y2,depth,    0, 1, 0,   1, 0, 0,
        x1, y2,0,        0, 1, 0,   0, 1, 0,
        x2, y2,0,        0, 1, 0,   0, 0, 1,
        x2, y2,0,        0, 1, 0,   1, 0, 0,
        x2, y2,depth,    0, 1, 0,   0, 1, 0,
        x1, y2,depth,    0, 1, 0,   0, 0, 1,

        // Bottom Side
        x1, y1,0,        0,-1, 0,   1, 0, 0,
        x1, y1,depth,    0,-1, 0,   0, 1, 0,
        x2, y1,0,        0,-1, 0,   0, 0, 1,
        x1, y1,depth,    0,-1, 0,   1, 0, 0,
        x2, y1,depth,    0,-1, 0,   0, 1, 0,
        x2, y1,0,        0,-1, 0,   0, 0, 1,

        x2, y2, depth,   0, 0, 1,   1, 0, 0,
        x2, y1, depth,   0, 0, 1,   0, 1, 0,
        x1, y2, depth,   0, 0, 1,   0, 0, 1,
        x1, y2, depth,   0, 0, 1,   1, 0, 0,
        x2, y1, depth,   0, 0, 1,   0, 1, 0,
